    ...
    <main className="relative min-h-screen overflow-hidden bg-linear-to-br from-slate-950 via-blue-950 to-cyan-950">
      ...
      <div className="relative container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          {/* Shop Cards or Fallback */}
          {shops.length === 0 ? (
            <Card className="group relative overflow-hidden border border-cyan-500/20 bg-gradient-to-br from-slate-950/40 via-blue-950/40 to-cyan-950/40 backdrop-blur-xl hover:border-cyan-400/40 hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-500 hover:-translate-y-1">
              ...
              <CardHeader className="relative pb-4 text-center">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500/15 to-blue-500/15 backdrop-blur-sm border border-cyan-400/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-cyan-500/10">
                  <Store className="w-6 h-6 text-cyan-300" />
                </div>
                <CardTitle className="text-xl text-white font-semibold">No Shops Available</CardTitle>
                <CardDescription className="text-cyan-100/60 mt-2 leading-relaxed">
                  You don&apos;t have any shops yet. Please contact your administrator.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="relative">
                <Button
                  asChild
                  disabled
                  className="w-full bg-gradient-to-r from-cyan-600/30 to-blue-600/30 text-white/50 border-0 shadow-none cursor-not-allowed"
                  size="lg"
                >
